// Script to generate different sized icons
const fs = require('fs');

const iconSizes = [
  { size: 57, name: 'icon-57.svg' },
  { size: 60, name: 'icon-60.svg' },
  { size: 72, name: 'icon-72.svg' },
  { size: 76, name: 'icon-76.svg' },
  { size: 114, name: 'icon-114.svg' },
  { size: 120, name: 'icon-120.svg' },
  { size: 144, name: 'icon-144.svg' },
  { size: 152, name: 'icon-152.svg' },
  { size: 167, name: 'icon-167.svg' },
...
const generateIcon = (size, filename) => {
  const iconSvg = `<svg width="${size}" height="${size}" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  fs.writeFileSync(filename, iconSvg);
