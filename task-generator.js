    ...
    generateTaskTemplates(homeData) {
        ...
        const essentialTasks = [
            {
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=QUA5qwKtNRo',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
            },
            {
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=7zb2qH9wg5c',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (hasExteriorResponsibility) {
            essentialTasks.push(
                {
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=eaHHYqJOkVE',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
                },
                {
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=zJ8g6-kLyic',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
            ...
            essentialTasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=B6DcJQkKmWA',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
            ...
            tasks.push(
                {
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=WoW4g6gTrNs',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
                },
                {
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=dGFu9WC5uPs',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
        ...
        if (homeData.features.miniSplits) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=DdGfJXHy1WU',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.wallAC) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=P6N8iAb0FhU',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.electricBaseboard) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=T8BKjg6NaQw',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.boiler) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=8hKZnY2a7_s',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.wellWater) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=R9KRFC7s6IM',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
            ...
            if (homeData.features.sedimentFilter) {
                tasks.push({
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=u8u0P8g4gJY',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
            ...
            if (homeData.features.uvFilter) {
                tasks.push({
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=O5kF6uHRx1s',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
            ...
            if (homeData.features.waterSoftener) {
                tasks.push({
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=QBfNCWXqbHM',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
            ...
            if (homeData.features.wholeHouseFilter) {
                tasks.push({
                    ...
                    youtubeUrl: 'https://www.youtube.com/watch?v=mfXq7YqNVvI',
                    dueDate: null,
                    lastCompleted: null,
                    isCompleted: false,
                    isTemplate: true
        ...
        if (homeData.features.septic) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=S6JLj_lQNio',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
            ...
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=KQrB4_uqgdU',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.fireplace) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=F7vfXGaHD3w',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.deck) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=tRZb9wWOlNk',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.pool) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=TGfHIR9wNu0',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.garage) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=S-_hLKyZLn8',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.basement) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=sEfKHRGKypo',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.sprinklerSystem) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=JQDHczJVmho',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.solarPanels) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=bDa2VzIIukU',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.backupGenerator) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=x9rpU0V8Lls',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
        ...
        if (homeData.features.securitySystem) {
            tasks.push({
                ...
                youtubeUrl: 'https://www.youtube.com/watch?v=A3rJ4W7S6j8',
                dueDate: null,
                lastCompleted: null,
                isCompleted: false,
                isTemplate: true
                ...
                regionalTasks = [
                    {
                        ...
                        youtubeUrl: 'https://www.youtube.com/watch?v=H5OAnO7TEI0',
                        dueDate: null,
                        lastCompleted: null,
                        isCompleted: false,
                        isTemplate: true
                    },
                    {
                        ...
                        youtubeUrl: 'https://www.youtube.com/watch?v=6kT4_gshkfE',
                        dueDate: null,
                        lastCompleted: null,
                        isCompleted: false,
                        isTemplate: true
                ...
                regionalTasks = [
                    {
                        ...
                        youtubeUrl: 'https://www.youtube.com/watch?v=zbQKLu8hGnE',
                        dueDate: null,
                        lastCompleted: null,
                        isCompleted: false,
                        isTemplate: true
                    },
                    {
                        ...
                        youtubeUrl: 'https://www.youtube.com/watch?v=eU25bMh5K_8',
                        dueDate: null,
                        lastCompleted: null,
                        isCompleted: false,
                        isTemplate: true
                ...
                regionalTasks = [
                    {
                        ...
                        youtubeUrl: 'https://www.youtube.com/watch?v=Hzrj5DQ-nkw',
                        dueDate: null,
                        lastCompleted: null,
                        isCompleted: false,
                        isTemplate: true
